            ...
            <div className="container my-2">
                <div className="row">
                        ...
                        <div className="card mb-3 pt-3 shadow">
                          <div className="card-body text-primary">
                            ...
                            <div className="row">
                              ...
                              <div className="col-3">
                                <button className="btn btn-light text-primary shadow px-2 py-4 
                          ...
                          <div className="row mt-2">
                              ...
                              <div className="col-3">
                                ...
                                fs-4" value="+" onClick={(e)=> setVal(val + e.target.value)}>+</
                           button>
                    ...
                    <div className="row mt-2">
                              ...
                              <div className="col-3">
                                <button className="btn btn-light text-primary shadow px-4 py-4 
                                fs-4" value="*" onClick={(e)=> setVal(val + e.target.value)}>x
                                </button>
                  </div>  
                 </div>
                 <div className="row mt-2">
